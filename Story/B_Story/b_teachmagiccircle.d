...
func int B_TeachMagicCircle(var C_Npc slf,var C_Npc oth,var int circle)
{
	...
	if(circle == 6)
	{
		...
		B_LogEntry(TOPIC_TalentMagicCircle,"«аклинани€ 6-го круга: огненный дождь, дыхание смерти, волна смерти, арми€ тьмы и сморщивание монстра.");
		return TRUE;
	};
	if(circle == 7)
	{
		PrintScreen(PRINT_LearnCircle_7,-1,-1,FONT_Screen,2);
		B_LogEntry(TOPIC_TalentMagicCircle,"«аклинани€ 7-го круга: протыкающа€ стрела Ќикиты, подрыв вселенной, призыв Ќикиты");
		return TRUE;
	};
};

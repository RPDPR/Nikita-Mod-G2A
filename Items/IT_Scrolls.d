...
const int Value_Sc_PierceArrow = 300;
const int Value_Sc_SumNik = 400;
...
instance ItSc_PierceArrow ( C_ITEM )
{
    Name			= "Свиток";
    MainFlag		= ITEM_KAT_RUNE;
    Flags			= ITEM_MULTI;
    Value			= Value_Sc_PierceArrow;
    ...
    Wear			= WEAR_EFFECT;
    Effect			= "SPELLFX_WEAKGLIMMER";
    Description		= NAME_SPL_PierceArrow; 			
    Text [0]		= Name_MageScroll;
    Text [1]		= NAME_Mana_needed;   	Count [1]	= SPL_Cost_Scroll; 		// Надо маны
    Text [5]		= NAME_Value;           Count [5]	= Value; 				// Цена
};

instance ItSc_SumNik(C_Item)
{
	name = NAME_Spruchrolle;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
	value = Value_Sc_SumNik;
	visual = "ItSc_SumGol.3DS";
	material = MAT_LEATHER;

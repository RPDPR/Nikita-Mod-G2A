...
func void ch_nik()
{
	Info_ClearChoices(CH_Guild);
	other.guild = GIL_NIK;
	Npc_SetTrueGuild(other,GIL_NIK);
	AI_UnequipArmor(hero);
};
...
instance DIA_CH_KREISE(C_Info)
{
	...
	permanent = TRUE;
	description = "Âûó÷èòü ìàãè÷åñêèé êðóã";
};
...
func void DIA_CH_KREISE_Info()
{
	...
	Info_AddChoice(dia_ch_kreise,"Ñåäüìîé êðóã",ch_kreise_7);
	Info_AddChoice(dia_ch_kreise,"Øåñòîé êðóã",ch_kreise_6);
	Info_AddChoice(dia_ch_kreise,"Ïÿòûé êðóã",ch_kreise_5);
	Info_AddChoice(dia_ch_kreise,"×åòâåðòûé êðóã",ch_kreise_4);
	Info_AddChoice(dia_ch_kreise,"Òðåòèé êðóã",ch_kreise_3);
	Info_AddChoice(dia_ch_kreise,"Âòîðîé êðóã",ch_kreise_2);
	Info_AddChoice(dia_ch_kreise,"Ïåðâûé êðóã",ch_kreise_1);
};
...
func void ch_kreise_7()
{
	Info_ClearChoices(dia_ch_kreise);
	B_TeachMagicCircle(self,other,7);
	B_SetKDFRunes();
};
...
func void DIA_CH_Runen_Info()
{
	...
	{
		Info_AddChoice(DIA_CH_Runen,B_BuildLearnString("7. Êðóã Ìàãèè",B_GetLearnCostTalent(other,NPC_TALENT_MAGE,7)),DIA_CH_Runen_7);
	};
	if(Npc_GetTalentSkill(other,NPC_TALENT_MAGE) == 5)
	{
		Info_AddChoice(DIA_CH_Runen,B_BuildLearnString("6. Êðóã Ìàãèè",B_GetLearnCostTalent(other,NPC_TALENT_MAGE,6)),DIA_CH_Runen_6);
	};
	if(Npc_GetTalentSkill(other,NPC_TALENT_MAGE) == 4)
	{
		Info_AddChoice(DIA_CH_Runen,B_BuildLearnString("5. Êðóã Ìàãèè",B_GetLearnCostTalent(other,NPC_TALENT_MAGE,5)),DIA_CH_Runen_5);
	};
	if(Npc_GetTalentSkill(other,NPC_TALENT_MAGE) == 3)
	{
		Info_AddChoice(DIA_CH_Runen,B_BuildLearnString("4. Êðóã Ìàãèè",B_GetLearnCostTalent(other,NPC_TALENT_MAGE,4)),DIA_CH_Runen_4);
	};
	if(Npc_GetTalentSkill(other,NPC_TALENT_MAGE) == 2)
	{
		Info_AddChoice(DIA_CH_Runen,B_BuildLearnString("3. Êðóã Ìàãèè",B_GetLearnCostTalent(other,NPC_TALENT_MAGE,3)),DIA_CH_Runen_3);
	};
	if(Npc_GetTalentSkill(other,NPC_TALENT_MAGE) == 1)
	{
		Info_AddChoice(DIA_CH_Runen,B_BuildLearnString("2. Êðóã Ìàãèè",B_GetLearnCostTalent(other,NPC_TALENT_MAGE,2)),DIA_CH_Runen_2);
	};
	if(Npc_GetTalentSkill(other,NPC_TALENT_MAGE) < 1)
	{
		Info_AddChoice(DIA_CH_Runen,B_BuildLearnString("1. Êðóã Ìàãèè",B_GetLearnCostTalent(other,NPC_TALENT_MAGE,1)),DIA_CH_Runen_1);
	};
};
...
func void DIA_CH_Runen_7()
{
	Info_ClearChoices(DIA_CH_Runen);
	Info_AddChoice(DIA_CH_Runen,Dialog_Back,DIA_CH_Runen_BACK);
	if(PLAYER_TALENT_RUNES[SPL_PierceArrow] == FALSE)
	{
		Info_AddChoice(DIA_CH_Runen,B_BuildLearnString(NAME_SPL_PierceArrow,B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PierceArrow)),CH_Training_Runen_Circle_7_SPL_PierceArrow);
	};
	if(PLAYER_TALENT_RUNES[SPL_SummonNikita] == FALSE)
	{
		Info_AddChoice(DIA_CH_Runen,B_BuildLearnString(NAME_SPL_SummonNikita,B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_SummonNikita)),CH_Training_Runen_Circle_7_SPL_SummonNikita);
	};
};

func void CH_Training_Runen_Circle_7_SPL_PierceArrow()
{
	B_TeachPlayerTalentRunes(self,other,SPL_PierceArrow);
};

func void CH_Training_Runen_Circle_7_SPL_SummonNikita()
{

...
//	Убрал, чтобы не было противоречий с новым диалогом варки напитков
...
instance KDF_506_Neoras_MakePotionsCommon (C_INFO)
{
	npc			= KDF_506_Neoras;
	condition		= KDF_506_Neoras_MakePotionsCommon_Condition;
	information		= KDF_506_Neoras_MakePotionsCommon_Info;
	important		= FALSE;
	permanent		= TRUE;
	description		= "У меня есть ингредиенты для приготовления напитков.";
};

func int KDF_506_Neoras_MakePotionsCommon_Condition()
{
	if(NeorasBrewsForYou == TRUE)
	{
		return TRUE;
...
func void KDF_506_Neoras_MakePotionsCommon_MakeChoices()
{
	Info_ClearChoices(KDF_506_Neoras_MakePotionsCommon);

	Info_AddChoice(KDF_506_Neoras_MakePotionsCommon, DIALOG_BACK, KDF_506_Neoras_MakePotionsCommon_Back);

	if	(NPC_HasItems(other, ItPl_Health_Herb_03) >= 2) && (NPC_HasItems(other, ItPl_Temp_Herb) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 300)
	{
		Info_AddChoice(KDF_506_Neoras_MakePotionsCommon, "Лечебный эликсир, 300 золота", KDF_506_Neoras_MakePotionsCommon_ItPo_Health_03);
	};

	if	(NPC_HasItems(other, ItPl_Perm_Herb) >= 1) && (NPC_HasItems(other, ItPl_Health_Herb_03) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 1000)
	{
		Info_AddChoice(KDF_506_Neoras_MakePotionsCommon, "Эликсир жизни, 1000 золота", KDF_506_Neoras_MakePotionsCommon_ItPo_Perm_Health);
	};

	if	(NPC_HasItems(other, ItPl_Mana_Herb_03) >= 2) && (NPC_HasItems(other, ItPl_Temp_Herb) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 300)
	{
		Info_AddChoice(KDF_506_Neoras_MakePotionsCommon, "Эликсир маны, 300 золота", KDF_506_Neoras_MakePotionsCommon_ItPo_Mana_03);
	};

	if	(NPC_HasItems(other, ItPl_Perm_Herb) >= 1) && (NPC_HasItems(other, ItPl_Mana_Herb_03) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 1000)
	{
		Info_AddChoice(KDF_506_Neoras_MakePotionsCommon, "Эликсир духа, 1000 золота", KDF_506_Neoras_MakePotionsCommon_ItPo_Perm_Mana);
	};
};

func void KDF_506_Neoras_MakePotionsCommon_Info()
{
	AI_Output(other, self, "KDF_506_Neoras_MakePotionsCommon_Info_15_01"); // У меня есть ингредиенты для приготовления напитков.
	AI_Output(self, other, "KDF_506_Neoras_MakePotionsCommon_Info_10_02"); // Так, давай посмотрим. Я могу предложить тебе:

	KDF_506_Neoras_MakePotionsCommon_MakeChoices();
};

func void KDF_506_Neoras_MakePotionsCommon_ItPo_Health_03()
{
	AI_Output(other, self, "KDF_506_Neoras_MakePotionsCommon_ItPo_Health_03_15_01"); // Лечебный эликсир
...
func void KDF_506_Neoras_MakePotionsCommon_ItPo_Perm_Health()
{
	AI_Output(other, self, "KDF_506_Neoras_MakePotionsCommon_ItPo_Perm_Health_15_01"); // Эликсир жизни
...
func void KDF_506_Neoras_MakePotionsCommon_ItPo_Mana_03()
{
	AI_Output(other, self, "KDF_506_Neoras_MakePotionsCommon_ItPo_Mana_03_15_01"); // Эликсир маны
...
func void KDF_506_Neoras_MakePotionsCommon_ItPo_Perm_Mana()
{
	AI_Output(other, self, "KDF_506_Neoras_MakePotionsCommon_ItPo_Perm_Mana_15_01"); // Эликсир духа
...
func void KDF_506_Neoras_MakePotionsCommon_Back()
{
	Info_ClearChoices(KDF_506_Neoras_MakePotionsCommon);
};

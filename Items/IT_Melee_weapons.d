instance ITMW_NIKITA_PIERCER(C_Item)
{
	name = "Протыканиум Никиты";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SWD;
	material = MAT_METAL;
	value = VALUE_NIKITAPIERCER;
	damageTotal = DAMAGE_NIKITAPIERCER;
	damagetype = DAM_EDGE;
	range = RANGE_NIKITAPIERCER;
	cond_atr[2] = ATR_STRENGTH;
	cond_value[2] = CONDITION_NIKITAPIERCER;
	visual = "ItMw_065_1h_sword_bastard_03.3DS";
	on_equip = equip_nikita_piercer;
	on_unequip = unequip_nikita_piercer;
	description = name;
	text[1] = "Этим клинком очень удобно протыкать все, что видишь.";
	text[2] = NAME_Damage;
	count[2] = damageTotal;
...
func void equip_nikita_piercer()
{
	B_AddFightSkill(self,NPC_TALENT_1H,15);
};

func void unequip_nikita_piercer()
{
	B_AddFightSkill(self,NPC_TALENT_1H,-15);
};

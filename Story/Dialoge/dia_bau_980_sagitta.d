...
func void BAU_980_Sagitta_MakePotionsCommon_MakeChoices()
{
	...
	{
		Info_AddChoice(BAU_980_Sagitta_MakePotionsCommon, "Чистая жизнь, 500 золота", BAU_980_Sagitta_MakePotionsCommon_ItPo_Health_Addon_04);
	};
	...
	{
		Info_AddChoice(BAU_980_Sagitta_MakePotionsCommon, "Эликсир маны, 300 золота", BAU_980_Sagitta_MakePotionsCommon_ItPo_Mana_03);
	};

	if	((NPC_HasItems(other, ItPo_Mana_01) >= 3) && (NPC_HasItems(other, ItPl_Temp_Herb) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 500))
	{
		Info_AddChoice(BAU_980_Sagitta_MakePotionsCommon, "Чистая мана, 500 золота", BAU_980_Sagitta_MakePotionsCommon_ItPo_Mana_Addon_04);
	};

	if	((NPC_HasItems(other, ItPl_Perm_Herb) >= 1) && (NPC_HasItems(other, ItPl_Mana_Herb_03) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 1000))
	{
		Info_AddChoice(BAU_980_Sagitta_MakePotionsCommon, "Эликсир духа, 1000 золота", BAU_980_Sagitta_MakePotionsCommon_ItPo_Perm_Mana);
	};

	if	((NPC_HasItems(other, ItPl_Dex_Herb_01) >= 1) && (NPC_HasItems(other, ItPl_Perm_Herb) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 1000))
	{
		Info_AddChoice(BAU_980_Sagitta_MakePotionsCommon, "Эликсир ловкости, 1000 золота", BAU_980_Sagitta_MakePotionsCommon_ItPo_Perm_DEX);
	};
};

func void BAU_980_Sagitta_MakePotionsCommon_Info()
{
	AI_Output(other, self, "BAU_980_Sagitta_MakePotionsCommon_Info_15_01"); // У меня есть кое-что для приготовления напитков.
	AI_Output(self, other, "BAU_980_Sagitta_MakePotionsCommon_Info_10_02"); // Так, давай посмотрим. Я могу предложить тебе:
...
{
	AI_Output(other, self, "BAU_980_Sagitta_MakePotionsCommon_ItPo_Health_Addon_04_15_01"); // Чистая жизнь
...
{
	AI_Output(other, self, "BAU_980_Sagitta_MakePotionsCommon_ItPo_Mana_03_15_01"); // Эликсир маны
...
{
	AI_Output(other, self, "BAU_980_Sagitta_MakePotionsCommon_ItPo_Mana_Addon_04_15_01"); // Чистая мана
...
{
	AI_Output(other, self, "BAU_980_Sagitta_MakePotionsCommon_ItPo_Perm_Mana_15_01"); // Эликсир духа
...
{
	AI_Output(other, self, "BAU_980_Sagitta_MakePotionsCommon_ItPo_Perm_DEX_15_01"); // Эликсир ловкости

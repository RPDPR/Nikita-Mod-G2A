...
func void KDW_14040_Addon_Riordian_ADW_MakePotionsCommon_MakeChoices()
{
	...
	{
		Info_AddChoice(KDW_14040_Addon_Riordian_ADW_MakePotionsCommon, "Эликсир маны, 300 золота", KDW_14040_Addon_Riordian_ADW_MakePotionsCommon_ItPo_Mana_03);
	};

	if	((NPC_HasItems(other, ItPl_Perm_Herb) >= 1) && (NPC_HasItems(other, ItPl_Mana_Herb_03) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 1000))
	{
		Info_AddChoice(KDW_14040_Addon_Riordian_ADW_MakePotionsCommon, "Эликсир духа, 1000 золота", KDW_14040_Addon_Riordian_ADW_MakePotionsCommon_ItPo_Perm_Mana);
	};

	if	((NPC_HasItems(other, ItPl_Dex_Herb_01) >= 1) && (NPC_HasItems(other, ItPl_Perm_Herb) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 1000))
	{
		Info_AddChoice(KDW_14040_Addon_Riordian_ADW_MakePotionsCommon, "Эликсир ловкости, 1000 золота", KDW_14040_Addon_Riordian_ADW_MakePotionsCommon_ItPo_Perm_DEX);
	};
};

func void KDW_14040_Addon_Riordian_ADW_MakePotionsCommon_Info()
{
	AI_Output(other, self, "KDW_14040_Addon_Riordian_ADW_MakePotionsCommon_Info_15_01"); // У меня есть кое-что для приготовления напитков.
	AI_Output(self, other, "KDW_14040_Addon_Riordian_ADW_MakePotionsCommon_Info_10_02"); // Так, давай посмотрим. Я могу предложить тебе:
...
{
	AI_Output(other, self, "KDW_14040_Addon_Riordian_ADW_MakePotionsCommon_ItPo_Mana_03_15_01"); // Эликсир маны
...
{
	AI_Output(other, self, "KDW_14040_Addon_Riordian_ADW_MakePotionsCommon_ItPo_Perm_Mana_15_01"); // Эликсир духа
...
{
	AI_Output(other, self, "KDW_14040_Addon_Riordian_ADW_MakePotionsCommon_ItPo_Perm_DEX_15_01"); // Эликсир ловкости

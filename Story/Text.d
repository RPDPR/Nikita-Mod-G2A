...
const string NAME_SPL_PierceArrow = "Протыкающая стрела";
const string NAME_SPL_Reserved_65 = "NAME_SPL_RESERVED_65";
const string NAME_SPL_SummonNikita = "Призыв Никиты";
...
const string NAME_ITMW_NIKITA_PIERCER = "Протыканиум Никиты";
...
const string PRINT_LearnCircle_7 = "Изучено: 7-й круг магии";

...
instance VLK_498_Ignaz_MakePotionsCommon (C_INFO)
{
	npc			= VLK_498_Ignaz;
	condition		= VLK_498_Ignaz_MakePotionsCommon_Condition;
	information		= VLK_498_Ignaz_MakePotionsCommon_Info;
	important		= FALSE;
	permanent		= TRUE;
	description		= "У меня есть кое-что для приготовления напитков.";
};

func int VLK_498_Ignaz_MakePotionsCommon_Condition()
{
...
func void VLK_498_Ignaz_MakePotionsCommon_Info()
{
	AI_Output(other, self, "VLK_498_Ignaz_MakePotionsCommon_Info_15_01"); // У меня есть кое-что для приготовления напитков.
	AI_Output(self, other, "VLK_498_Ignaz_MakePotionsCommon_Info_10_02"); // Так, давай посмотрим. Я могу предложить тебе:

	Info_ClearChoices(VLK_498_Ignaz_MakePotionsCommon);

	if	((NPC_HasItems(other, ItPl_Speed_Herb_01) >= 1) && (NPC_HasItems(other, ItPl_Temp_Herb) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 500))
	{
		Info_AddChoice(VLK_498_Ignaz_MakePotionsCommon, "Напиток ускорения, 500 золота", VLK_498_Ignaz_MakePotionsCommon_ItPo_Speed);
	};


	Info_AddChoice(VLK_498_Ignaz_MakePotionsCommon, DIALOG_BACK, VLK_498_Ignaz_MakePotionsCommon_Back);

};

func void VLK_498_Ignaz_MakePotionsCommon_ItPo_Speed()
{
	AI_Output(other, self, "VLK_498_Ignaz_MakePotionsCommon_ItPo_Speed_15_01"); // Напиток ускорения
...
func void VLK_498_Ignaz_MakePotionsCommon_Back()
{
	Info_ClearChoices(VLK_498_Ignaz_MakePotionsCommon);
};

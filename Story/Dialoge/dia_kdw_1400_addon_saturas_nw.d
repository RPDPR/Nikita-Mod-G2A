...
func void DIA_Addon_Saturas_Hallo_weitdu()
{
	AI_Output(self,other,"DIA_Addon_Saturas_Hallo_weitdu_14_00");	//Ты хоть имеешь представление о том, что ты наделал?
	AI_Output(self,other,"DIA_Addon_Saturas_Hallo_weitdu_14_01");	//Ты настолько сильно пошатнул базовую структуру магического естества, что в Хоринисе все чуть не оглохли.
	AI_Output(self,other,"DIA_Addon_Saturas_Hallo_weitdu_14_02");	//Скажи спасибо, что Барьера больше нет.
	AI_Output(other,self,"DIA_Addon_Saturas_Hallo_weitdu_15_03");	//Что же ты жалуешься, старче? Все ведь сработало как надо.
	AI_Output(self,other,"DIA_Addon_Saturas_Hallo_weitdu_14_04");	//(высокомерно) Следите за языком, юноша!
	AI_Output(self,other,"DIA_Addon_Saturas_Hallo_weitdu_14_05");	//(раздраженно) Что, во имя всех стихий, тебе здесь нужно? 
...
func void DIA_Addon_Saturas_Hallo_notwendig()
{
	...
	DIA_Addon_Saturas_Hallo_weitdu();
};

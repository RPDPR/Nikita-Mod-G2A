...
{
	ThereIsNoFightingHere = "SVM_20_ThereIsNoFightingHere";	//Драться с Никитой запрещенооо!
	WhatAreYouDoing = "SVM_20_WhatAreYouDoing";	//Твое пипало стрелы просит!
	Dead = "SVM_20_Dead";	//Никита умер.
	Aargh_1 = "SVM_20_Aargh_1";	//Аааааа!
	Aargh_2 = "SVM_20_Aargh_2";	//Аааааа!
	Aargh_3 = "SVM_20_Aargh_3";	//Аааааа!
	ITookYourGold = "SVM_20_ITookYourGold";	//УУУУУУ, ЗОЛОТО!
	ShitNoGold = "SVM_20_ShitNoGold";	//Хыхыхы, БОМЖ.
	ITakeYourWeapon = "SVM_20_ITakeYourWeapon";	//Я, пожалуй, заберу твой самотык, ЫХЫХЫ.
	LookingForTroubleAgain = "SVM_20_LookingForTroubleAgain";	//Ты напрашиваешься на двойное протыкание!
	WeaponDown = "SVM_20_WeaponDown";	//Убери оружие или протыкания не избежаааать!
	ISaidWeaponDown = "SVM_20_ISaidWeaponDown";	//Протыкание ближе, чем тебе кажется!
	YouAskedForIt = "SVM_20_YouAskedForIt";	//АААААААА!
	...
	IGetYouStill = "SVM_20_IGetYouStill";	//Ам-ням! Ам-ням, привет!
	DieEnemy = "SVM_20_DieEnemy";	//Ам-ням, я тебя проткну!
	...
	KillEnemy = "SVM_20_KillEnemy";	//Сдохни, сосунок!!
	EnemyKilled = "SVM_20_EnemyKilled";	//Бойся протыкания!
	...
	WiseMove = "SVM_20_WiseMove";	//Да, засунь свой самотык себе в жопу и не доставай!
	NextTimeYoureInForIt = "SVM_1_NextTimeYoureInForIt";	//(себе под нос) Мы еще посмотрим...
	OhMyHead = "SVM_20_OhMyHead";	//(себе под нос) Ой, мое пипало...

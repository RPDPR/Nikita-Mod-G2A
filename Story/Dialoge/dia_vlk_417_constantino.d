...
// Приготовление напитков "по заказу"

instance VLK_417_Constantino_MakePotionsCommon (C_INFO)
{
	npc			= VLK_417_Constantino;
	condition		= VLK_417_Constantino_MakePotionsCommon_Condition;
	information		= VLK_417_Constantino_MakePotionsCommon_Info;
	important		= FALSE;
	permanent		= TRUE;
	description		= "У меня есть кое-что для приготовления напитков.";
};

func int VLK_417_Constantino_MakePotionsCommon_Condition()
{
	// Чтобы Константино согласился готовить напитки, ГГ должен быть гражданином
	// !! Закомментировано для тестинга !!
...
func void VLK_417_Constantino_MakePotionsCommon_MakeChoices()
{
	Info_ClearChoices(VLK_417_Constantino_MakePotionsCommon);
	Info_AddChoice(VLK_417_Constantino_MakePotionsCommon, DIALOG_BACK, VLK_417_Constantino_MakePotionsCommon_Back);

	if	
		(
			(NPC_HasItems(other, ItPl_Health_Herb_03) >= 2) && (NPC_HasItems(other, ItPl_Temp_Herb) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 300)
		)
	{
		Info_AddChoice(VLK_417_Constantino_MakePotionsCommon, "Лечебный эликсир, 300 золота", VLK_417_Constantino_MakePotionsCommon_ItPo_Health_03);
	};
	...
	{
		Info_AddChoice(VLK_417_Constantino_MakePotionsCommon, "Чистая жизнь, 500 золота", VLK_417_Constantino_MakePotionsCommon_ItPo_Health_Addon_04);
	};

	if	((NPC_HasItems(other, ItPl_Perm_Herb) >= 1) && (NPC_HasItems(other, ItPl_Health_Herb_03) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 1000))
	{
		Info_AddChoice(VLK_417_Constantino_MakePotionsCommon, "Эликсир жизни, 1000 золота", VLK_417_Constantino_MakePotionsCommon_ItPo_Perm_Health);
	};

	if	((NPC_HasItems(other, ItPo_Mana_01) >= 3) && (NPC_HasItems(other, ItPl_Temp_Herb) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 500))
	{
		Info_AddChoice(VLK_417_Constantino_MakePotionsCommon, "Чистая мана, 500 золота", VLK_417_Constantino_MakePotionsCommon_ItPo_Mana_Addon_04);
	};


	if	((NPC_HasItems(other, ItPl_Strength_Herb_01) >= 1) && (NPC_HasItems(other, ItPl_Perm_Herb) >= 1) && (NPC_HasItems(other, ItMi_Gold) >= 1000))
	{
		Info_AddChoice(VLK_417_Constantino_MakePotionsCommon, "Эликсир силы, 1000 золота", VLK_417_Constantino_MakePotionsCommon_ItPo_Perm_STR);
	};

};

func void VLK_417_Constantino_MakePotionsCommon_Info()
{
	AI_Output(other, self, "VLK_417_Constantino_MakePotionsCommon_Info_15_01"); // У меня есть кое-что для приготовления напитков.
	AI_Output(self, other, "VLK_417_Constantino_MakePotionsCommon_Info_10_02"); // Так, давай посмотрим. Я могу предложить тебе:

	VLK_417_Constantino_MakePotionsCommon_MakeChoices();
};

func void VLK_417_Constantino_MakePotionsCommon_ItPo_Health_03()
{
	AI_Output(other, self, "VLK_417_Constantino_MakePotionsCommon_ItPo_Health_03_15_01"); // Лечебный эликсир
...
func void VLK_417_Constantino_MakePotionsCommon_ItPo_Health_Addon_04()
{
	AI_Output(other, self, "VLK_417_Constantino_MakePotionsCommon_ItPo_Health_Addon_04_15_01"); // Чистая жизнь
...
func void VLK_417_Constantino_MakePotionsCommon_ItPo_Perm_Health()
{
	AI_Output(other, self, "VLK_417_Constantino_MakePotionsCommon_ItPo_Perm_Health_15_01"); // Эликсир жизни
...
func void VLK_417_Constantino_MakePotionsCommon_ItPo_Mana_Addon_04()
{
	AI_Output(other, self, "VLK_417_Constantino_MakePotionsCommon_ItPo_Mana_Addon_04_15_01"); // Чистая мана
...
func void VLK_417_Constantino_MakePotionsCommon_ItPo_Perm_STR()
{
	AI_Output(other, self, "VLK_417_Constantino_MakePotionsCommon_ItPo_Perm_STR_15_01"); // Эликсир силы
...
func void VLK_417_Constantino_MakePotionsCommon_Back()
{
	Info_ClearChoices(VLK_417_Constantino_MakePotionsCommon);
};
